    ...
    <section id="home">
      ...
      <div class="quick-access-container">
        <div class="quick-access-box">
          <div class="mng-option" id="quick-location">
            <a href="#reserve">
              <button class="mng-welcome-btn btn">Find us</button>
            </a>
          </div>
        </div>
        <div class="quick-access-box">
          <div class="mng-option" id="quick-menu">
            <a href="#menu">
              <button class="mng-welcome-btn btn">Our menu</button>
            </a>
          </div>
        </div>
        <div class="quick-access-box">
          <div class="mng-option" id="quick-gallery">
            <a href="#gallery">
              <button class="mng-welcome-btn btn">Gallery</button>
            </a>
          </div>
        </div>
      </div>
...
foreach ($conn->query($sql) as $row) { echo('
        <div class="menu-item">
          '); echo("
          <h2>" . $row['Name']. "&nbsp;&nbsp;&nbsp;" .$row['Price']. "$". "</h2>
          "); echo('
          <p class="menu-item-desc">' . $row['Description']. "</p>
          "); echo('<button
        ...
        <div class="reservation-form">
          ...
          >
            ...
            <div class="reservation-form-end">
              <button type="submit" class="reservation-form-btn btn">
                Reserve
              </button>
            </div>
          </form>
    ...
    <footer id="footer">
      ...
      <div class="footer-link">
        <a href="https://github.com/JakubFlaczynski/PolishDream">Github</a>
        <div class="footer-line"></div>
      </div>
      <div class="footer-link">
