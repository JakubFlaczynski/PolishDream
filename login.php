        ...
        <div class="login-form-container">
            ...
            <div class="login-form-body">
              <form action="./php/validate.php" name="Form" method="post" onsubmit="return validateForm()">
                <input type="text" placeholder="Username" name="Username" value="admin" class="login-form-input"/><br><br>
                <input type="password" placeholder="Password" name="Password" value="admin" class="login-form-input"/><br><br>
